...
- [SEP-41 Token Example](../examples/tokens/01-sep41-token/)
- [SEP-41 Extensions & Allowances](../examples/tokens/02-sep41-extensions/)
- [Pausable Token Pattern](../examples/tokens/03-optimized-operations/)
