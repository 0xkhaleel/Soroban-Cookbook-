...
flows described in the [Wallet Ecosystem Survey](../docs/wallet-ecosystem.md)
and [Wallet Integration Guide](../docs/wallet-integration.md).
...
than a browser extension (see [Standards Compliance](../docs/wallet-ecosystem.md#3-standards-compliance)
...
described in the [Wallet Integration Guide's Testing Guide](../docs/wallet-integration.md#testing-guide) —
...
- [Wallet Ecosystem Survey](../docs/wallet-ecosystem.md) — which wallets support mobile and how
- [Wallet Integration Guide](../docs/wallet-integration.md) — connecting and signing, including the existing Testing Guide section
